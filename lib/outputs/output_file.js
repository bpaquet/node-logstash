...
OutputFile.prototype.afterLoadConfig = function(callback) {
  logger.info('Start writing to file ' + this.file);

  this.error_buffer = error_buffer.create('output OutputFile to ' + this.file, this.error_buffer_size, this);
...
OutputFile.prototype.close = function() {
  logger.info('Cloing output on file ' + this.file);
