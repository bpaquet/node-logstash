...
AbstractHttp.prototype.sendHttpRequest = function(http_options, body) {
  ...
  if (http_options.data_callback) {
    data_callback = http_options.data_callback;
    delete http_options.data_callback;
  }

  var end_callback = function() {};
  if (http_options.end_callback) {
    end_callback = http_options.end_callback;
    delete http_options.end_callback;
  }
