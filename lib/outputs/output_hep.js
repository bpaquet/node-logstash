...
OutputHep.prototype.preHep = function(data,cid) {

  var hep_proto = { "type": "HEP", "version": 3, "payload_type": this.hep_type, "captureId": this.hep_id, "capturePass": this.hep_pass, "ip_family": 2};
  ...
  // pair correlation id from pattern
	hep_proto.correlation_id = #{hep_cid};
	if (hep_proto.correlation_id != '') {
		// Pack HEP3
  	return hepjs.encapsulate(msg,rcinfo);
  }
}
}
