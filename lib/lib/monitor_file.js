...
MonitoredFile.prototype.start = function(start_index) {
  logger.info('Starting monitoring, current fd : ' + this.fd);
      ...
      if (exists) {
        ...
        fs.open(this.filename, 'r', function(err, fd) {
          ...
          if (start_index === undefined) {
            logger.info('Start reading at end');
            ...
            logger.info('Start reading at ' + start_index);
          ...
          this.dir_watcher = fs.watch(dir, function(event) {
            if (event == 'rename') {
              process.nextTick(function() {
                logger.info('Directory change, file exists : ' + this.file_exists);
...
MonitoredFile.prototype.tail = function(buffers) {
  logger.debug('Tailing fd : ' + this.fd);
  if (this.fd) {
