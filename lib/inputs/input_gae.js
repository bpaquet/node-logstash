...
function InputGae() {
  ...
  this.mergeConfig({
    ...
    port_field: 'port',
    required_params: ['key'],
    optional_params: ['ssl', 'polling', 'servlet_name', 'access_logs_type', 'access_logs_field_name'],
    default_values: {
      'ssl': false,
      'polling': 60,
      'servlet_name': 'logs',
...
InputGae.prototype.poll = function() {
  ...
  var req = this.proto.get(this.base_url + '?start_timestamp=' + this.current_timestamp + '&log_key=' + this.key, function(res) {
